...
{
    [Serializable]
    public class NaturezaJuridicaDTO : IEquatable<NaturezaJuridicaDTO>
    {
        ...
        /// </summary>
        public NaturezaJuridicaDTO(NaturezaJuridicaDTO obj)
        {
            this.Id = obj.Id;
        ...
        #region IEquatable<NaturezaJuridicaDTO> Members
        public bool Equals(NaturezaJuridicaDTO obj)
        {
